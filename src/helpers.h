...
/// \param[in] pTextParagraph The \c ITextPara implementation to validate against.
///
...
/// \brief <em>Retrieves whether a tab position is a valid one, i.e. it defines a tab</em>
///
/// \overload
///
/// \param[in] tabPosition The tab position to check.
/// \param[in] pTextParagraph The \c ITextPara implementation to validate against.
///
/// \return \c TRUE if the tab position is valid; otherwise \c FALSE.
...
///
/// \sa RichTextBox::OnGetDragImage, RichTextBox::OLEDrag,
