...
#define OEMRESOURCE
	...
	//#include <atldbgmem.h>			// incompatible with GDI+
#else
	#define USE_STL
#endif
...
// Requires Windows 8 SDK or newer:
...
#endif
#ifndef AURL_ENABLETELNO
	#define AURL_ENABLETELNO 4
#endif
#ifndef AURL_ENABLEEAURLS
	#define AURL_ENABLEEAURLS 8
#endif
#ifndef AURL_ENABLEDRIVELETTERS
	#define AURL_ENABLEDRIVELETTERS 16
#endif
#ifndef AURL_DISABLEMIXEDLGC
	#define AURL_DISABLEMIXEDLGC 32
#endif

// Not defined at all:
/*#ifndef EN_LINK_DO_DEFAULT
	#define EN_LINK_DO_DEFAULT ??
#endif*/
#ifndef IMF_TKBAUTOCORRECTION
	// https://blogs.msdn.com/b/murrays/archive/2012/08/31/richedit-spell-checking-autocorrection-and-prediction.aspx#10669052
	// seems to be equal to IMF_IMEUIINTEGRATION
