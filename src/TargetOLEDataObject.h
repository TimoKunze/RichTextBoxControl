...
///
/// \if UNICODE
///   \sa RichTextBoxCtlLibU::IOLEDataObject, SourceOLEDataObject, RichTextBox,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa RichTextBoxCtlLibA::IOLEDataObject, SourceOLEDataObject, RichTextBox,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE TargetOLEDataObject : 
    ...
    #ifdef UNICODE
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_RichTextBoxCtlLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #else
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_RichTextBoxCtlLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #endif
{
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, RichTextBox::get_SupportOLEDragImages,
	///       RichTextBoxCtlLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa SetDropDescription, RichTextBox::get_SupportOLEDragImages,
	///       RichTextBoxCtlLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, RichTextBox::put_SupportOLEDragImages,
	///       RichTextBoxCtlLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription,RichTextBox::put_SupportOLEDragImages,
